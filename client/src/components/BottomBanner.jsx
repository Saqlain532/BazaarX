...
const BottomBanner = () => {
  return (
    <div className='relative mt-24' >
      ...
      src={assets.bottom_banner_image} alt="banner" />
      <img  className='w-full  md:hidden'
      src={assets.bottom_banner_image_sm} alt="banner" />
          ...
          <div>
            ...
            {features.map((feature, index)=>(
                       <div key={index}  className='flex items-center gap-4 mt-2' >
                           <img className='md:w-11 w-9'
                           src={feature.icon} alt="feature.title" />
                           <div>
                                <h3 className='text-lg md:text-xl font-semibold' >{feature.title}</h3>
                                <p className='text-gary-500/700 text-xs md:text-sm' >  {feature.description}</p>
                            </div>
